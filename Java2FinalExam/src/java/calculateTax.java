/*
* CTREATED BY MATT BROTEHN 4-18-19
*/
...
/**
 *
 * @author mbrothen 4-18-19
 */
@Named(value = "calculateTax")
@RequestScoped
public class calculateTax {
    ...
    //Build results string, call computeTax to get taxbill in string
    String s = "Taxable Income: " + taxableIncome + "<br>" + 
      "Filing Status: " + filingStatus + "<br>" +
      "<font color=\"#FF0000\">" +
      "Tax: " + computeTax(filingStatus, taxableIncome) +
      "</font>";
